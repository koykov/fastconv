...
func BenchmarkCrc32Byte1Tableless(b *testing.B) {
	...
	b.ReportAllocs()
	for i := 0; i < b.N; i++ {
		r := Crc32Byte1Tableless(crc32In, 0)
		if h != r {
			b.Error(h, "not equal to", r)
		}
	}
...
func BenchmarkCrc32Byte1Tableless2(b *testing.B) {
	h := uint32(0x607650b0)
	b.ReportAllocs()
	for i := 0; i < b.N; i++ {
		r := Crc32Byte1Tableless2(crc32In, 0)
		if h != r {
			b.Error(h, "not equal to", r)
		}
	}
